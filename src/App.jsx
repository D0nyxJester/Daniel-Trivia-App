    ...
    fetch('/api/user')
      ...
      .then(data => {
        if (data && data.displayName) {
          setUser(data)
          setIsLoggedIn(true)
          // Fetch trivia results immediately after confirming login
        ...
        {isLoggedIn ? (
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ textAlign: 'center', padding: '20px', backgroundColor: '#f8f9fa', borderRadius: '8px', marginBottom: '20px' }}>
              <p>You can use the trivia feature without signing in, but sign in to save and view your results!</p>
              <button 
                ...
                {answerOptions.map((option, index) => (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: '16px',
                      textAlign: 'left',
                      color: '#333' // Add color for button text
                    }}
                    onMouseOver={(e) => {
                      e.target.style.backgroundColor = '#e9ecef'
                      e.target.style.color = '#000' // Ensure text stays dark on hover
                    }}
                    onMouseOut={(e) => {
              ...
              <table className="compact-table">
                <thead>
                  <tr>
                    ...
                    <th>Result</th>
                    <th>Date</th>
                    <th>Action</th> {/* Add new column header */}
                  </tr>
                </thead>
                <tbody>
